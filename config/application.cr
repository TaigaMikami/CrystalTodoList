...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Crystal Todo List web application."
  #
  #
  ...
  #
  # settings.secret_key_base= j1UZn3-_lJ2OX7FwQWSvh0Oeucf8IFC4JfXQroZ1ckk
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("crystal_todo_list.log", "w"))
  #
  #
end
